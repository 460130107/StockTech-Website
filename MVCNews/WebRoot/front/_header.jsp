...
<div id="top" class="navbar-inverse text-right">
	<ul class="list-inline">		
		<li class='${param.index=="account"?"active":"" }'><a
					href="front/account.jsp">登录</a>|</li>
		<li class='${param.index=="account"?"active":"" }'><a
					href="front/signup.jsp">注册</a>|</li>
		<li class='${param.index=="account"?"active":"" }'><a
					href="front/account.jsp">忘记密码</a></li>
	</ul>
</div>
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
			      ...
			      <ul class="dropdown-menu list-inline" data-toggle="toggle_ul" style="width:500px;">
				...
				<li class='${param.index=="help"?"active":"" }'><a
					href="front/help.jsp">帮助中心</a></li>
				<li class="dropdown">
