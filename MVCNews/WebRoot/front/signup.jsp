    	...
    	<div class="col-md-6">
			...
			<div class="sign-up-field">
				...
				<input id="id_phone" class="form-control" type=tel name="email"
					placeholder="填入手机号有利于帐户安全">
			</div>
			
			<div class="sign-up-field">
				<p>真实姓名</p>
				<input id="id_realname" class="form-control" type="text" name="name" placeholder="斯多克服务要求实名认证" maxlength="50">
			</div>
			
			<div class="sign-up-field">
				<p>身份证号</p>
				<input id="id_idno" class="form-control" type="text" name="name" placeholder="身份证号/护照号" maxlength="50">
			</div>
