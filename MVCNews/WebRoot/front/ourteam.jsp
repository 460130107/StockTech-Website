    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" id="myNav">
                <li class="active"><a href="front/ourteam.jsp#about">公司简介</a></li>
                <li><a href="front/ourteam.jsp#team">管理团队</a></li>
                <li><a href="front/ourteam.jsp#expert">专家顾问</a></li>
                <li><a href="front/ourteam.jsp#responsibility">社会责任</a></li>
                <li><a href="front/ourteam.jsp#partner">合作伙伴</a></li>               
            </ul>
        </div>
        <div class="col-xs-9">           
