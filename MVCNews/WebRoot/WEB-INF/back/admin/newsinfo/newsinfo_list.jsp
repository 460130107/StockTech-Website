...
<TABLE BORDER="1" cellpadding="5" cellspacing="0" bgcolor="F2F2F2" width="100%">
	...
	<TR onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		...
		<td align="center" valign="middle"><span class="STYLE6"><a href="#" onclick="show('<%=request.getContextPath()%>/back/admin/newsinfo/NewsInfo_show.action?pid=${newsvo.newsInfoId}')">${newsvo.newsInfoTitle}</a></span></td>
		...
		<td align="center" valign="middle"><span class="STYLE6"><a href="<%=request.getContextPath()%>/back/admin/newsinfo/NewsInfo_updatepre?pid=${newsvo.newsInfoId}&cp=${page}&ls=${size}&pg=${url}">修改</a></span></td>
		<td align="center" valign="middle"><span class="STYLE6"><a href="<%=request.getContextPath()%>/back/admin/newsinfo/NewsInfo_delete?pid=${newsvo.newsInfoId}&cp=${page}&ls=${size}&pg=${url}" onclick="return doDelete()">删除</a></span></td>
	</TR>
	</c:forEach>
</table>
</center>
