...
<center> 
<form action="<%=request.getContextPath()%>/back/admin/newsinfo/NewsInfo_update" method="post" onSubmit="return validate(this)" enctype="multipart/form-data">
<table border="1" width="100%" cellpadding="5" cellspacing="0" bgcolor="F2F2F2" id="myTB">
	...
	<tr onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		...
		<td><input type="text" name="author" value="${newsinfo.newsInfoDescribe}" onBlur="validateAuthor(this.value)"></td>
		<td><span id="author_msg"><font color="RED">*</font></span></td>
	</tr>
	<tr onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
