...
<s:iterator value="all" var="item">
	<TR onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		<td align="center" valign="middle"><span class="STYLE6"><a href="#" onclick="show('<%=request.getContextPath()%>/back/admin/admin/Admin_show.action?adminid=${item.adminId}')">${item.adminId}</a></span></td>
		...
		<td align="center" valign="middle"><span class="STYLE6">
			<a href="<%=request.getContextPath()%>/back/admin/admin/Admin_updatepre.action?adminid=${item.adminId}">修改</a>
		</span></td>
		<td align="center" valign="middle"><span class="STYLE6">
			<a href="<%=request.getContextPath()%>/back/admin/admin/Admin_delete?adminid=${item.adminId}" onclick="return doDelete(${size})">删除</a>
		</span></td>
	</TR>
</s:iterator>
</table>
